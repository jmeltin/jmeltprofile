...
function create() {
	...
	cursors = new Phaser.Keyboard(game);
	cursors.left = cursors.addKey(Phaser.Keyboard.LEFT);
	cursors.right = cursors.addKey(Phaser.Keyboard.RIGHT);
	cursors.up = cursors.addKey(Phaser.Keyboard.UP);
